...
struct alignas(64) SearchData
{
    ...
    /**
     * 其实没有必要存这5个搜索数组，因为就两个csr，这个是确定的
    */
    ...
    /**
     * 每个层级需要一个终止边，这个可以和上面的candiate.second合并，但是没啥必要
     */
    // int expanding_vertex[5];
    ...
    SearchData(SearchData &&) = default;
    SearchData &operator=(SearchData &&) = default;
